...
if(LOGGED_IN) {
	if((ADDING || EDITING) && !empty($catid)) {
		...
		if(file_exists("$modules_dir/$cat_type/controller.php") && file_exists("$modules_dir/$cat_type/view.php") && !is_null($cat_type)) {
			$module_exists = true;
			$module_css = (file_exists("$modules_dir/$cat_type/css") && is_dir("$modules_dir/$cat_type/css")) ? EXPANSE_URL.'modules/'.$cat_type.'/css/styles.css.php' : (file_exists("$modules_dir/$cat_type/styles.css") ? EXPANSE_URL.'modules/'.$cat_type.'/styles.css' : '');
			$module_js = (file_exists("$modules_dir/$cat_type/javascript") && is_dir("$modules_dir/$cat_type/javascript")) ? EXPANSE_URL.'modules/'.$cat_type.'/javascript/javascript.js.php' : (file_exists("$modules_dir/$cat_type/javascript.js") ? EXPANSE_URL.'modules/'.$cat_type.'/javascript.js' : '');
...
?>
	<div class="container<?php echo ' '.empty($the_type) ? ' mainPage' : ''; ?>">
		<form method="post" action="" enctype="multipart/form-data" id="post" name="post" class="form-stacked" autocomplete="off">
			<?php
