...
<div class="row-fluid">
	<div class="span3">
		<canvas id="totalsChart" width="166" height="166"></canvas>
		<script>
			var data1 = [{value: <?php echo $totals['user_count']; ?>,color:"#d8e6d3"}, {value : <?php echo $totals['total_count'] - $totals['user_count']; ?>,color : "#42758d"}]
		</script>
		<p><?php printf(L_OVER_TOTAL_USAGE, $totals['user_count'], $totals['total_count']); ?></p>
	</div>
	<div class="span6">
		<canvas id="summaryChart" width="570" height="166"></canvas>
		<script>
			<?php echo $auth->createSummaryChart(); ?>
		</script>
		<p>Pages <b>online</b> within your categories.</p>
	</div>
</div>
<hr>
=======
