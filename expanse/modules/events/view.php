...
?>
<script type="text/javascript" src="modules/events/CalendarPopup.js"></script>
<?php
...
?>
	...
	<div class="row">
		<div class="span8">
			<div class="clearfix">
				<label for="event_date"><?php echo L_EVENTS_DATE ?></label>
				<div class="input">
					<input name="event_date" type="text" class="span8 formfields" id="event_date" />
				</div>
			</div>
		</div>
		<div class="span8">
		...
		<div class="row">
			<div class="span8">
				<div class="clearfix">
					<label for="event_date"><?php echo L_EVENTS_DATE ?></label>
					<div class="input">
						<input name="event_date" type="text" class="span8 formfields" id="event_date" value="<?php echo view($items->event_date); ?>" />
					</div>
				</div>
			</div>
			<div class="span8">
