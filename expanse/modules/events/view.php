			...
			<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="event_date" class="span8" id="event_date" value="" />
							<input type="text" name="event_time" class="span4 timepicker-default" id="event_time" value="" />
						</div>
					</div>
				</div>
				<div class="span5">
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-prepend">
								...
								<input name="url" type="text" class="span12 formfields" id="url" />
							</div>
						</div>
					</div>
				</div>
		...
		<div class="row-fluid">
			<div class="span6">
				<div class="control-group">
					...
					<div class="controls">
						<input name="title" type="text" class="span12 formfields" id="title" value="<?php echo view($items->title);?>" />
					</div>
				</div>
				<div class="row-fluid">
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<div class="controls">
									<input type="text" name="event_date" class="span8" id="event_date" value="<?php echo view(date('d F Y', $items->event_date)); ?>" />
									<input type="text" name="event_time" class="span4 timepicker-default" id="event_time" data-settime="<?php echo view(date('h:i A', $items->event_date)); ?>"  value="<?php echo view(date('h:i A', $items->event_date)); ?>" />
								</div>
							</div>
						</div>
					</div>
					<div class="span5">
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-prepend">
					                <span class="add-on">http://</span>
									<input name="url" type="text" class="span12 formfields" id="url" value="<?php echo view($items->url); ?>" />
								</div>
							</div>
						</div>
					</div>
