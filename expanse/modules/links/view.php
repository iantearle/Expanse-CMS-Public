...
if(ADDING):
	...
	<div class="row">
		<div class="span8">
			<div class="clearfix">
				<label for="title"><?php echo L_LINKS_TITLE ?></label>
				<div class="input">
			...
			<div class="clearfix">
				...
				<div class="input">
					<div class="input-prepend">
						...
						<input  type="text" name="url" class="span11 formfields" id="url" />
					</div>
				</div>
			</div>		
		</div>
...
if(EDITING): 
	if(EDIT_SINGLE): ?>
			...
			<div class="span16">
				<div class="clearfix">
					...
					<div class="input">
						<div class="input-prepend">
		                	<span class="add-on">http://</span>
							<input type="text" name="url" class="span11 formfields" id="url" value="<?php echo view($items->url); ?>" />
						</div>
					</div>
				</div>		
			</div>
		...
		<div class="actions">
			</label><input name="submit" type="submit" class="btn primary" id="submit" value="<?php echo L_BUTTON_EDIT ?>" />
		</div>
