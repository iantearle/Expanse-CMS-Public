...
<input type="checkbox" name="use_default_thumbsize" value="1" class="cBox" id="use_default_thumbsize"  <?php echo ($items->use_default_thumbsize == 1) ? 'checked="checked"' : '';?>  /><br /></span>
<?php
}
function doPaypal(){
$items =& $this->items;
