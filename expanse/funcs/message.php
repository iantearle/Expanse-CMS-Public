...
<body>
	...
	?>
		...
		?>
			<li>It appears that you've left your hostname blank. Try putting in the host where expanse can find your database.</li>
		<?php
		}
		if(empty($CONFIG['user'])) {
		?>
			<li>It appears that you've not entered in a username . Try entering in a username.</li>
		<?php
		}
		if(empty($CONFIG['pass'])) {
		?>
			<li>It appears that you've left your password blank. Not all servers require a password, but many do. Try entering in a password.</li>
		<?php
		}
		...
		<p>If you've ruled out all of the above, you have two options left.<br />You can contact your host and ask them for help, or you could even find help at the <a href="http://forums.expansecms.org/" target="_blank">expanse Forums</a>.</p>
	<?php
	...
	?>
		...
		if(empty($CONFIG['db'])) {
		?>
			<li>It appears that you've left the name of your database blank. Try putting in the database name.</li>
		<?php
		} else {
		?>
	...
	?>
		<a href="http://expansecms.org/" target="_blank"><img src="/expanse/images/expanselove.gif" alt="Expanse loves you!" width="110" height="33" border="0" /></a>
	</div>
</body>
</html>
