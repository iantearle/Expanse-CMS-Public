...
require(dirname(__FILE__) . '/class.comment.php');
require(dirname(__FILE__) . '/class.contact.php');
...
$subsections = new Expanse('sections');
...
define('STARTCAT', $option->startcategory);
