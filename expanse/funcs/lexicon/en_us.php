...
$LEX['mailer_request_body'] 			= 'Someone, hopefully you, has requested to change your password. If you did not request this, ignore this email, and all will be fine.<br /><br />If you do wish to reset your password, you can do so by going to this address <a href="%s">%s</a>';
...
$LEX['mailer_changed_details'] 			= '<strong>What is my username?</strong> %s<br /><strong>What is my new password?</strong> %s';
