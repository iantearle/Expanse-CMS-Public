<?php
$files =  array(
'jquery.min', 'jquery-ui.min', 'jquery-cookie', 'jquery.nearest.min', 'underscore.min', 'backbone.min', 'bootstrap', 'expanse.main',

// , 'prototype.plugins','moo.fx', 'moo.fx.pack', 'autosuggest', 'expanse.main.old',
);
if(isset($_GET['full'])){
